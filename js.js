...
const snake = {
    ...
    getNextStepHeadPoint() {
        ...
        switch (this.direction) {
            ...
            case 'right':
                if (firstPoint.x > config.getRowsCount() - 2) {
                    return {x: 0, y: firstPoint.y}
                }
                return {x: firstPoint.x + 1, y: firstPoint.y};
            case 'down':
                if (firstPoint.y > config.getColsCount() - 2) {
...
const game = {
    ...
    reset() {
        ...
        this.stop();
        this.counts = 0;
        document.getElementById('counter').textContent = this.counts;
    ...
    tickHandler() {
        ...
        if (this.food.isOnPoint(this.snake.getNextStepHeadPoint())) {
            ...
            this.counts++;
            document.getElementById('counter').textContent = this.counts.toString();
